      ...
      <div class="card-content">
        <form data-toggle="validator" action="{{ route($view.'store') }}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="row">
              <div class="form-group col-sm-6">
                <input type="password" data-minlength="6" name="password" required class="form-control" id="inputPassword" placeholder="Password">
                <div class="help-block">Minimum of 6 characters</div>
              </div>
              <div class="form-group col-sm-6">
                <input type="password" class="form-control" required id="inputPasswordConfirm" data-match="#inputPassword" data-match-error="Whoops, these don't match" placeholder="Confirm">
                <div class="help-block with-errors"></div>
              </div>
            </div>
          </div>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="file" id="input-file-now" name="image" class="dropify" data-error="Complete this field please">
            {{-- <div class="help-block with-errors"></div> --}}
          </div>

          <div class="form-group col-md-6 hr">
            <label for="input-file-now">Upload CV</label>
            <input type="file" id="input-file-now" name="cv" class="dropify" data-error="Complete this field please">
          </div>
          <hr>
